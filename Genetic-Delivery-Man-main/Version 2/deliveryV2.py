...
class Order:
    ...
    '''
    Provides a basic structure for representing delivery orders.
    Encapsulates essential information such as order identifier, destination city, wait time, and time limit within each instance.
    Ensures that wait time and time limit are valid non-negative values, enforcing constraints to prevent unexpected behavior.
    '''
