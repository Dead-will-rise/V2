...
class Displayer:
    ...
    '''
    Provides a central point for managing display settings and colors used in the visual representation of routes on a map.
    Encapsulates color constants and margin size, ensuring consistency and ease of maintenance throughout the display functionality.
    '''
