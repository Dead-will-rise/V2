...
class Population:
    ...
    '''
    The __copy__ method is designed to create a shallow copy of a Population object. 
    Shallow copying creates a new object but does not recursively duplicate nested objects within it.
    '''
